 ...
 * @version $Revision: 776 $ ($Author: jacmorel $)
 */
public class TableTag extends HtmlTableTag
{
     ...
     * logger.
     */
    private static Log log = LogFactory.getLog(org.displaytag.tags.TableTag.class);
     ...
     */
    private org.displaytag.model.TableModel tableModel;
     ...
     * @throws org.displaytag.exception.InvalidTagAttributeValueException if value is not "page" or "list"
     */
    ...
    public int doStartTag() throws JspException
    {
        ...
        // always return EVAL_BODY_BUFFERED to get column headers also if the table is empty
     ...
     * @return <code>int</code> either EVAL_BODY_BUFFERED or SKIP_BODY depending on whether another iteration is desired.
     */
    protected int doIteration()
    {
        ...
        if (this.tableIterator.hasNext())
        {
            ...
            this.currentRow = setRowObjectForCellValues(iteratedObject, this.rowNumber);
    ...
    protected Row setRowObjectForCellValues(Object iteratedObject, int rowNumber) {
     ...
     * @throws org.displaytag.exception.ObjectLookupException for problems in evaluating the expression in the "name" attribute
    ...
    protected void writeExport(ExportView exportView) throws IOException, JspException
    {
        ...
        {
            response.setHeader("Content-StoryDisposition", //$NON-NLS-1$
    ...
    protected void setupViewableData()
    {
        ...
        if (this.pagesize > 0)
        {
            ...
            if(this.pageNumber == -1){
                fullList = CollectionUtil.getListFromObject(originalData, 0, ((List)originalData).size());
            } else
            {
