...
public class PersonTimesheetForm extends AbstractEditorForm {
   ...
   //DEBT(FORM) Refactor to use base class utility. See TimeEditorForm for example
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ActionErrors errors = new ActionErrors();

        if (this.dateFormat == null) {
        String format = getResources(request).getMessage(request.getLocale(), "format.date");
